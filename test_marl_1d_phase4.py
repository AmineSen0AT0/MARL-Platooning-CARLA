...
#
# # IMPORT YOUR PHASE 4 ENVIRONMENT
# from my_carla_env_gymnasium.carla_env_phase4 import CarlaEnv
#
#
# # We need the exact same wrapper used during training!
...
#             else:
#                 self.is_disturbing = False
#                 print(f"🏎️ [Step {self.step_count}] Pace Car disturbance ended.")
#
...
#
# def main():
#     print("👁️ INITIALIZING PHASE 4 VISUAL EVALUATION...")
#
#     params = {
...
#         'town': 'Town04',
#         'task_mode': 'random',
#         'max_time_episode': 1000,  # 100 seconds is plenty for a visual test
#         'max_waypt': 12,
#         'obs_range': 32,
#         'lidar_bin': 0.125,
#         'd_behind': 12,
...
#     model_path = "./marl_v2v_fixed_collision_models_50k_penality_collision/marl_v2v_fixed_collision_50k_penality_collision_2000032_steps.zip"
#
#     print(f"🧠 Loading the 90k Step MARL Brain from: {model_path}")
...
#     truncated = False
#
#     print("✅ Simulation running! Open your Pygame/CARLA window to watch.")
#
#     while not (terminated or truncated):
#         # deterministic=True forces the AI to use its best learned policy without random exploration
#         action, _ = model.predict(obs, deterministic=True)
#
#         obs, reward, terminated, truncated, info = env.step(action)
#
#         # Slow down the loop slightly so you can watch it in real-time
#         time.sleep(0.03)
#
...
def main():
    ...
    print(f"📈 Graph successfully saved as {filename}! Upload this to Overleaf.")
    plt.show()
